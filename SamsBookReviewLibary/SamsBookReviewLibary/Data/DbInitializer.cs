...
namespace SamsBookReviewLibary.Data
{
    public static class DbInitializer
    {
        public static void Initialize(AuthorContext context)
        {
            ...
            var author3 = new Author { FirstName = "David", LastName = "Gemmell", BirthDate = DateTime.Parse("1948-08-1"), Country = "England", Info = "A British author of heroic fantasy, best known for his debut, Legend. A former journalist and newspaper editor, Gemmell had his first work of fiction published in 1984. He went on to write over thirty novels. Gemmell's works display violence", ImgThumbNail = "https://d1nao0k9edgivc.cloudfront.net/wp-content/uploads/2014/02/David-Gemmell.jpg" };
